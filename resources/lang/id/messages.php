...
return [
    ...
    'units_per_order_in_stock_unit' => 'Unit per pesanan (dalam :unit).',
    'safety_stock_auto_in_stock_unit' => 'Stok Pengaman <small class="text-muted">(Otomatis, dalam :unit)</small>',
    'avg_usage_x_safety_days' => 'Rata2 Penggunaan × Hari Pengaman',
    'signal_point_auto_in_stock_unit' => 'Titik Sinyal <small class="text-muted">(Otomatis, dalam :unit)</small>',
    'avg_usage_x_lead_time_plus_safety_stock' => '(Rata2 Penggunaan × Waktu Tunggu) + Stok Pengaman',
    'image' => 'Gambar',
    'upload_raw_material_image' => 'Unggah Gambar Bahan Baku',
    'recalculate_analysis_button' => 'Hitung Ulang Analisis',
    'recalculate_analysis_confirm' => 'Proses ini akan menghitung ulang semua data analisis inventaris. Lanjutkan?',
    'search_by_raw_material_name' => 'Cari berdasarkan nama bahan baku...',
    'order_status' => 'Status Pesanan',
    'needs_order' => 'Perlu Dipesan',
    'stock_ok' => 'Stok OK',
    'needs_reordering_alert' => 'Perlu Dipesan Ulang',
    ...
    'raw_material_avg_daily_usage_calculated' => 'Rata2 Penggunaan Harian <small class="text-muted">(Dihitung)</small>',
    'raw_material_replenish_quantity' => 'Kuantitas Pemesanan Ulang',
    'raw_material_lead_time_policy' => 'Waktu Tunggu (Kebijakan)',
    'raw_material_safety_stock_days_policy' => 'Hari Stok Pengaman (Kebijakan)',
    'raw_material_safety_stock_calculated' => 'Stok Pengaman <small class="text-muted">(Dihitung)</small>',
    'raw_material_signal_point_calculated' => 'Titik Sinyal <small class="text-muted">(Dihitung)</small>',
    ...
    'conversion_factor_info' => 'Jumlah :usage_unit dalam 1 :stock_unit.',
    'unit_price_info' => 'Harga per :stock_unit.',
    'current_stock_in_unit_info' => 'Jumlah dalam :unit.',
