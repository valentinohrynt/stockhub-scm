...
<div class="modern-form-container">
    <form action="{{ $route }}" method="POST">
        ...
        <div class="form-section">
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    <label for="password" class="form-label">Password @if(!$isEdit)<span class="text-danger">*</span>@endif</label>
                    <input type="password" name="password" id="password" class="form-control @error('password') is-invalid @enderror" @if(!$isEdit) required @endif>
                    @if ($isEdit)
                ...
                <div class="col-md-6">
                    ...
                    <input type="password" name="password_confirmation" id="password_confirmation" class="form-control" @if(!$isEdit) required @endif>
                </div>
            </div>
        </div>
