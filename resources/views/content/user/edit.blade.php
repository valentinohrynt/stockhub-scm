...
@section('title', __('messages.edit_user_title') . ': ' . $user->name)
    ...
    <div class="modern-container">
        <div class="header-section">
             <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                <div>
                    <h2 class="page-title">{{ __('messages.edit_user_title') }}</h2>
                    <p class="header-subtitle mb-0">{{ __('messages.modifying_user', ['name' => $user->name]) }}</p>
                </div>
